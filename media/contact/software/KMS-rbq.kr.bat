...
:start
echo 本脚本需要右键管理员运行
echo 和谐都市云服务官网https://www.okidc.net
echo 为您提供一键KMS服务。永久自动续期！本功能完全免费！
...
if DEFINED _Office%1Path (
    ...
    cscript //nologo ospp.vbs /sethst:kms.rbq.kr >nul
...
if defined %EditionID% (
	...
	cscript //Nologo %windir%\system32\slmgr.vbs /skms kms.rbq.kr
